...
#ifndef I2C_ADAPTER
#define I2C_ADAPTER 0 //12
#endif
#ifdef MSM
#define GPIO_MHL_INT  				9 
#define GPIO_BB_RESET 				8
#else
...
bool	use_spi			= 0;
int		crystal_khz		= 19200;	// Titan SK has 19.2MHz crystal so the default
bool	bpp_on_wb		= 0;
...
#else
	i2c_bus_adapter = i2c_get_adapter(4);
#endif
